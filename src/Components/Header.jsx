    ...
    return (
      <div>
        <div className="text-center space-y-3">
          <h1 className="text-4xl lg:text-6xl font-bold">The Dragon News</h1>
          <p className="text-[#706F6F]">Journalism Without Fear or Favour</p>
          <p className="text-[#706F6F]">Sunday, November 27, 2022</p>
        </div>
        <div className="flex justify-center gap-5 items-center bg-[#F3F3F3] p-2 mt-7">
          ...
          <p className="font-semibold text-[#403F3F]">Match Highlights: Germany vs Spain — as it happened   !   Match Highlights: Germany vs Spain as...</p>
        </div>
